...
namespace BetterUI
{
    public static class ItemStats
    {
        ...
        public static void Initialize()
        {
            ...
            RegisterStat(RoR2Content.Items.FocusConvergence, "BETTERUI_CHARGESPEED", 0.30f, 0.30f, 3);
        ...
        public static void GetItemStats(StringBuilder stringBuilder, ItemDef itemDef, int stacks, CharacterMaster master)
        {
            if (itemStats.TryGetValue(itemDef, out var stats))
            {
                ...
                {
                    int limitedStacks = Math.Min(stacks, itemStat.stackLimit);
                    float baseValue = itemStat.stackingFormula(itemStat.value, itemStat.stackValue, limitedStacks);
